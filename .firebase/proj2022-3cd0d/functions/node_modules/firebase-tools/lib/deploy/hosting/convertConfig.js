...
async function convertConfig(context, deploy) {
    ...
    config.rewrites = (_a = deploy.config.rewrites) === null || _a === void 0 ? void 0 : _a.map((rewrite) => {
    ...
    config.redirects = (_b = deploy.config.redirects) === null || _b === void 0 ? void 0 : _b.map((redirect) => {
    ...
    config.headers = (_c = deploy.config.headers) === null || _c === void 0 ? void 0 : _c.map((header) => {
        const headers = {};
