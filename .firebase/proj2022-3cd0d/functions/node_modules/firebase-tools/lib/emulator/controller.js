...
async function startAll(options, showUI = true) {
    ...
    if (shouldStart(options, types_1.Emulators.FIRESTORE)) {
        ...
        if (((_d = options.config.src.emulators) === null || _d === void 0 ? void 0 : _d.singleProjectMode) === undefined ||
            ((_e = options.config.src.emulators) === null || _e === void 0 ? void 0 : _e.singleProjectMode)) {
            if (projectId) {
